...
* TRANSLATION
  * Translate two small labels on commit status list (#12821)
...
* ENHANCEMENTS
  ...
  * Only show part of members on organization dashboard and add paging for organization members page (#9092)
...
* BUGFIXES
  ...
  * Fix organization user watch repository (#2670)
  ...
  * Restricting access to fork functionality to users with Code access (#2534)
...
* BUGFIXES
  ...
  * Backport: Restricting access to fork functionality to users with Code access (#2542)
  ...
  * Fix missing collaborative repos (#2367) (#2382)
  ...
  * fix collborators lack of units on organization repositories (#1968)
  ...
  * fix bug to deny to add organization as a member of an organization or team (#1815)
